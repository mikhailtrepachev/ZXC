...
{
    /// <inheritdoc />
    public partial class AddStocksPortfolio : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromAccountId1 = table.Column<int>(type: "integer", nullable: true),
                    ToAccountId = table.Column<string>(type: "text", nullable: false),
                    ToAccountId1 = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Accounts_FromAccountId1",
                        column: x => x.FromAccountId1,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transactions_Accounts_ToAccountId1",
                        column: x => x.ToAccountId1,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_FromAccountId1",
                table: "Transactions",
                column: "FromAccountId1");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ToAccountId1",
                table: "Transactions",
                column: "ToAccountId1");
        }
